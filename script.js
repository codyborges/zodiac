...
//functions
function horoscope(){
  if (parseInt(month.value) == 03 && parseInt(day.value) > 21 && parseInt(day.value) <= 31 || parseInt(month.value) == 04 && parseInt(day.value) >1 && parseInt(day.value) <= 19){
  ...
  }else if (parseInt(month.value) == 04 && parseInt(day.value) > 20 && parseInt(day.value) <= 30  || parseInt(month.value) == 05 && parseInt(day.value) > 1 && parseInt(day.value) <= 20){
  ...
  }else if (parseInt(month.value) == 05 && parseInt(day.value) > 21 && parseInt(day.value) <= 31 || parseInt(month.value) == 06 && parseInt(day.value) > 1 && parseInt(day.value) <= 20){
    sign.innerHTML = "Gemini"
    answer.innerHTML = "Upsetting events in the neighborhood might have family members in a funk. This could be something major like construction crews tearing up the streets, or something as minor as a bout of bad weather. No matter, Taurus, it's going to make your lives a bit more difficult for a while, but you'll have to bear with it. In the meantime, try to cheer everyone up by throwing an impromptu party."
  }else if (parseInt(month.value) == 06 && parseInt(day.value) >21 && day.value <= 30 || parseInt(month.value) == 07 && parseInt(day.value) > 1 && parseInt(day.value) <= 22){
  ...
  }else if (parseInt(month.value) == 07 && parseInt(day.value) >23 && parseInt(day.value) <= 31 || parseInt(month.value) == 08 && parseInt(day.value) > 1 && parseInt(day.value) <= 22){
    sign.innerHTML = "Leo"
  ...
  }else if  (parseInt(month.value) == 08 && parseInt(day.value) > 23 && parseInt(day.value) <= 31 || parseInt(month.value) == 09 && parseInt(day.value) > 1 && parseInt(day.value) <= 22){
  ...
  }else if (parseInt(month.value) == 09 && parseInt(day.value) > 23 && parseInt(day.value) <= 30 || parseInt(month.value) == 10 && parseInt(day.value) > 1 && parseInt(day.value) <= 22){
  ...
  }else if (parseInt(month.value) == 10 && parseInt(day.value) > 23 && parseInt(day.value) <= 31 || parseInt(month.value) == 11 && parseInt(day.value) > 1 &&  parseInt(day.value) <= 21){
  ...
  }else if (parseInt(month.value) == 11 && parseInt(day.value) > 22 && parseInt(day.value) <= 30 || parseInt(month.value) == 12 && parseInt(day.value) >1 && parseInt(day.value) <= 21){
  ...
  }else if (parseInt(month.value) == 12 && parseInt(day.value) > 22 && parseInt(day.value) <= 31 || parseInt(month.value) == 01 && parseInt(day.value) > 1 && parseInt(day.value) <= 19){
